...
_FLAT_PATHS: dict[str, DataPath] = {
    ...
    "daily_energy_discharged": ("energy", "daily_output_energy"),
    "monthly_energy_discharged": ("energy", "monthly_output_energy"),
    "total_energy_discharged": ("energy", "local_total_output_energy"),
