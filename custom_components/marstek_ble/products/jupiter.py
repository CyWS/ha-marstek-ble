...
class JupiterPackets:
    ...
    DETAILED_TELEMETRY = PacketSchema("jupiter_detailed_telemetry", 0x14, 165, 165)
...
class JupiterRuntimeData:
    ...
    bms_firmware_version: int | None = source_field(sources={_RUNTIME: FieldSource(0x35, "<H"), _DETAIL: FieldSource(0x64, "<B")}, entities=_sensor("bms_firmware_version", "BMS Firmware Version", entity_category=_DIAGNOSTIC))
...
class JupiterBatteryData:
    ...
    voltage: float | None = source_field(sources={_DETAIL: FieldSource(0x65, "<H", divide_by(100))}, entities=_sensor("battery_voltage", "Battery Voltage", native_unit_of_measurement=UnitOfElectricPotential.VOLT, device_class=SensorDeviceClass.VOLTAGE, state_class=SensorStateClass.MEASUREMENT, suggested_display_precision=2))
    current: float | None = source_field(sources={_DETAIL: FieldSource(0x67, "<h", divide_by(10))}, entities=_sensor("battery_current", "Battery Current", native_unit_of_measurement=UnitOfElectricCurrent.AMPERE, device_class=SensorDeviceClass.CURRENT, state_class=SensorStateClass.MEASUREMENT))
    temperature: float | None = source_field(sources={_DETAIL: FieldSource(0x69, "<h", divide_by(10))}, entities=_sensor("battery_temperature", "Battery Temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, state_class=SensorStateClass.MEASUREMENT, entity_category=_DIAGNOSTIC))
    error_code_1: int | None = source_field(sources={_DETAIL: FieldSource(0x6B, "<H")}, entities=_sensor("bms_error_code_1", "BMS Error Code 1", entity_category=_DIAGNOSTIC))
    warning_code_1: int | None = source_field(sources={_DETAIL: FieldSource(0x6D, "<H")}, entities=_sensor("bms_warning_code_1", "BMS Warning Code 1", entity_category=_DIAGNOSTIC))
    error_code_2: int | None = source_field(sources={_DETAIL: FieldSource(0x6F, "<H")}, entities=_sensor("bms_error_code_2", "BMS Error Code 2", entity_category=_DIAGNOSTIC))
    warning_code_2: int | None = source_field(sources={_DETAIL: FieldSource(0x71, "<H")}, entities=_sensor("bms_warning_code_2", "BMS Warning Code 2", entity_category=_DIAGNOSTIC))
    cell_flags: int | None = source_field(sources={_DETAIL: FieldSource(0x73, "<B")}, entities=_sensor("cell_flags", "Cell Flags", entity_category=_DIAGNOSTIC))
    status_flags: int | None = source_field(sources={_DETAIL: FieldSource(0x74, "<B")}, entities=_sensor("bms_status_flags", "BMS Status Flags", entity_category=_DIAGNOSTIC))
    pack_count: int | None = source_field(sources={_DETAIL: FieldSource(0x75, "<H")}, entities=_sensor("battery_pack_count", "Battery Pack Count", entity_category=_DIAGNOSTIC))
    packs: list[JupiterBatteryPackData] = repeated_section_field(JupiterBatteryPackData, count=4, sources={_DETAIL: RepeatedSectionSource(0x79, 8)}, active_count_attribute="pack_count", child_device=_BATTERY_CHILDREN)
    temp_sensor_1: float | None = source_field(sources={_DETAIL: FieldSource(0x99, "<h", float)}, entities=_sensor("battery_temp_sensor_1", "Battery Temperature Sensor 1", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
    temp_sensor_2: float | None = source_field(sources={_DETAIL: FieldSource(0x9B, "<h", float)}, entities=_sensor("battery_temp_sensor_2", "Battery Temperature Sensor 2", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
    temp_sensor_3: float | None = source_field(sources={_DETAIL: FieldSource(0x9D, "<h", float)}, entities=_sensor("battery_temp_sensor_3", "Battery Temperature Sensor 3", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
    temp_sensor_4: float | None = source_field(sources={_DETAIL: FieldSource(0x9F, "<h", float)}, entities=_sensor("battery_temp_sensor_4", "Battery Temperature Sensor 4", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
    environment_temperature: float | None = source_field(sources={_DETAIL: FieldSource(0xA1, "<h", float)}, entities=_sensor("bms_environment_temperature", "BMS Environment Temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
    mosfet_temperature: float | None = source_field(sources={_DETAIL: FieldSource(0xA3, "<h", float)}, entities=_sensor("bms_mosfet_temperature", "BMS MOSFET Temperature", native_unit_of_measurement=UnitOfTemperature.CELSIUS, device_class=SensorDeviceClass.TEMPERATURE, entity_category=_DIAGNOSTIC))
